...
@Component({
  selector: 'app-informe-ejecucion',
  templateUrl: './informe-ejecucion.component.html',
  styleUrls: ['./informe-ejecucion.component.css']
})
export class InformeEjecucionComponent implements OnInit {
  codpro:number;
  persona: any;
  codper:any;
  generado:any;
